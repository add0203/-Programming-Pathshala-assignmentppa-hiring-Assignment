...
const Blog = () => {
  ...
  return (
    <div className="px-4 lg:px-14 max-w-screen-2xl mx-auto my-12" id="faq">
      ...
      >
        <h2 className="text-4xl text-neutralDGrey font-semibold mb-4 dark:text-darkh1">
          Caring is the new marketing
        </h2>
        <p className="text-sm text-neutralGrey mb-8 md:w-3/4 mx-auto dark:text-darkh2">
        ...
        {blogs.map((blog) => (
          <div key={blog.id} className="mx-auto relative mb-12 cursor-pointer">
            ...
            <div className="text-center px-4 py-8 bg-white shadow-lg rounded-md md:w-3/4 mx-auto absolute -bottom-12 left-0 right-0">
              <h3 className="mb-3 text-neutralGrey font-semibold dark:text-neutralBlack">
                {blog.title}
              </h3>
