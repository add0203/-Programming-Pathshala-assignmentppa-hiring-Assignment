...
const Services = () => {
  ...
  return (
    <div className="md:px-14 px-4 py-16 max-w-screen-2xl mx-auto" id="service">
      ...
      >
        <h2 className="text-4xl text-neutralDGrey font-semibold mb-2 dark:text-darkh1">
          Our Clients
        </h2>
        <p className="text-neutralGrey dark:text-darkh2">
      ...
      >
        <h2 className="text-4xl text-neutralDGrey font-semibold mb-3 dark:text-darkh1">
      ...
      >
        {services.map((service) => (
          <div
            key={service.id}
            className="px-4 py-8 text-center md:w-[300px] mx-auto md:h-80 rounded-md shadow cursor-pointer hover:-translate-y-5 hover:border-b-4 hover:border-indigo-700 transition-all duration-300 flex items-center justify-center h-full dark:bg-white"
          >
            <div className="">
